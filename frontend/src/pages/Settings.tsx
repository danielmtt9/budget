        ...
        <div className="flex flex-col p-8 w-full max-w-7xl mx-auto gap-8">
            ...
            <div className="bg-white dark:bg-slate-800/20 border border-slate-200/80 dark:border-white/10 p-6 rounded-xl flex flex-col gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-end">
                    ...
                    <button
                        onClick={handleSync}
                        disabled={syncing || !configuredAccessUrl}
                        className="flex items-center justify-center gap-2 rounded-lg min-h-[44px] h-11 bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-sm font-semibold px-5 hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors disabled:opacity-50 active:scale-95"
                    >
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        {syncStatus.last_sync_at && (
                            <p className="text-xs text-slate-500 dark:text-slate-500 italic">
                                System Time: {new Date(syncStatus.last_sync_at).toLocaleString()}
                            </p>
                        )}
                    </div>
                </div>
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-6 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        <label className="flex flex-col flex-1">
                            ...
                            <select
                                className="form-select w-full rounded-lg text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 focus:border-primary min-h-[44px] h-11 px-4 text-sm"
                                value={newRuleType}
                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 rounded-lg min-h-[44px] h-11 bg-primary text-white text-sm font-semibold px-5 hover:bg-primary/90 transition-colors disabled:opacity-50 active:scale-95"
                        >
